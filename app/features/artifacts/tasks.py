...
from app.features.artifacts.model import ArtifactStatus
...
async def generate_structured_content(
        ...
        schema_map = {
            ArtifactType.QUIZ: QuizOutput,
            ArtifactType.FLASHCARDS: FlashcardOutput,
            ArtifactType.FAQ: FAQOutput,
            ArtifactType.STUDY_GUIDE: StudyGuideOutput,
            ArtifactType.SUMMARY: SummaryOutput,
            ArtifactType.MINDMAP: MindMapOutput,
            ArtifactType.SLIDE_DECK: SlideDeckOutput,
        }

        schema = schema_map.get(artifact_type, SummaryOutput)
