...
ARTIFACT_CONFIGS: Dict[str, ArtifactRetrievalConfig] = {
    ...
    # Voice overview wants broad, engaging, explanatory coverage similar to a
    # study guide/summary blend, since the script needs to flow as a narrative.
    "voice_overview": ArtifactRetrievalConfig(
